package com.vce.baselib.custom.flowlayout;
...
public class TagFlowLayout extends FlowLayout
    ...
    private boolean mustSelect=false; //是否必选
     ...
     * @param must
     */
    public void setMustSelect(boolean must){
        this.mustSelect = must;
    }
    ...
    private void doSelect(TagView child, int position) {
        if (!child.isChecked()) {
            ...
            if((mSelectedView==null || mSelectedView.size()<=1) && mustSelect){
                //
            }else {
