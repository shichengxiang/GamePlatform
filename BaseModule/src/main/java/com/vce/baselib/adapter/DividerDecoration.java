...
//    private static final int[] ATTRS = new int[]{ R.drawable.divider_line };
...
//        a.recycle();
    ...
    public DividerDecoration(Context context, int orientation,boolean isEnd) {
//        final TypedArray a = context.obtainStyledAttributes(ATTRS);
//        mDivider = a.getDrawable(0);
//        if (mDivider == null) {
//            Log.w(TAG, "@android:attr/listDivider was not set in the theme used for this "
...
//        a.recycle();
    ...
    public DividerDecoration(Context context, int orientation,int d) {
        mDivider = ContextCompat.getDrawable(context,d);
        setOrientation(orientation);
    }
...
//        }
        Log.e("divider=","position ="+position);
        if (mOrientation == VERTICAL) {
